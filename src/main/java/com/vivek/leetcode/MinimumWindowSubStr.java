...
public class MinimumWindowSubStr {
    ...
    public String findMatch(String s, String t) {
        String x = validateMe(s, t);
        if (x != null) return x;

        Map<Character, Integer> dict = new HashMap<>();
        for (int i = 0; i< t.length(); i++){
            dict.put(t.charAt(i), dict.getOrDefault(i, 0) + 1);
        }
    ...
    private String validateMe(String s, String t) {
